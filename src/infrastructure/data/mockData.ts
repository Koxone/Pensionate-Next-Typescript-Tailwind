...
import type {
  PensionPlan,
  PensionPlanDetails,
} from "@domain/entities/PensionPlan";
...
export const pensionPlans: PensionPlan[] = [
  ...
  },
  {
    ...
    description:
      "Maximiza tus rendimientos con una estrategia de inversión a largo plazo.",
...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Calculamos con precisión el monto de tu pensión según tu historial laboral.",
    icon: "calculator",
  ...
  },
  {
    ...
    description:
      "Optimiza tus ahorros con estrategias de inversión diseñadas para tu perfil.",
    icon: "chart",
...
export const features = [
  ...
  },
  {
    ...
    description:
      "Transparencia total en nuestras comisiones. Sabes exactamente cuánto pagas.",
    icon: "eye",
  },
  {
    id: "3",
    ...
    description:
      "Un experto te acompaña en cada paso para diseñar el mejor plan para ti.",
    icon: "users",
  },
  {
    id: "4",
...
export const processSteps = [
  {
    ...
    description:
      "Programa una consulta gratuita con uno de nuestros asesores expertos.",
  },
  {
    step: 2,
  ...
  },
  {
    ...
    description:
      "Diseñamos una estrategia de ahorro e inversión personalizada.",
  },
  {
    step: 4,
